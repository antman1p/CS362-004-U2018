...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  //adventurer = 7 in enum
      if (card == 7){
        //call function that implements adventurer card
      ...
      //smithy = 13 in enum
      if (card == 13){
        //call function that implements smithy card
        smithyCard(currentPlayer, state, handPos);
      }

      //council_room = 8 in enum
      if (card == 8){
        //call function that implements council_room card
        council_roomCard(currentPlayer, state, handPos);
      }

      //village = 14 in enum
      if (card == 14){
        //call function that implements village card
        villageCard(currentPlayer, state, handPos);
      }

      //steward = 18 in enum
      if (card == 18){
        //call function that implements steward card
...
//refactored function that implements adventurer card effect 
...
//refactored function that implements smithy card effect
      //contains a bug - see Assignment-2.pdf for details
...
//refactored function that implements council_room card effect
  //may contain a bug - see Assignment-2.pdf for details
...
//refactored function that implements village card effect
  //may contain a bug - see Assignment-2.pdf for details
...
//refactored function that implements steward card effect
  //may contain a bug - see Assignment-2.pdf for details
